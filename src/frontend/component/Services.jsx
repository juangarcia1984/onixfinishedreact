...
export default function Services() {
    return (
        <div>
            <div className="mt-5 animated-section" id="services">
                <h1 className="display-4 fw-semibold text-dark">Services</h1>
                <hr style={{ width: "50%", border: "3px solid blue" }} className="rounded" />
                <p className="fs-5 lh-lg text-secondary">We are a interior design service that focus on what's best for your home and what's best for you!</p>
                <p className="fs-5 lh-lg text-secondary">Some text about our services - what we do and what we offer. We are lorem ipsum consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure
